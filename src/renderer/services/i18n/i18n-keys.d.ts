...
export type I18nKey =
  ...
  | 'conversation.history.ungrouped'
  ...
  | 'conversation.historySearch.searchContent'
  | 'conversation.historySearch.searchTitle'
  | 'conversation.historySearch.shortTitle'
  | 'conversation.historySearch.title'
  | 'conversation.historySearch.titlePlaceholder'
